...
import CreditsButtons from "../creditsButton/CreditsButtons";

const CreditsBanner = ({ credit, size, tag }) => {
  return (
    <div className='drop-shadow-lg bg-white flex justify-around items-center flex-col p-3 min-h-full min-w-[24vw] rounded-xl'>
      ...
      <h3>Only for {parseInt(credit / 1.5) + " ₹"}</h3>
